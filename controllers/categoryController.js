...
module.exports.deleteCategory = async (req, res) => {
    try {
        ...
        if(childCategories.length > 0){
           return res.status(400).json({ message: " cannot delete category with subcategories. Reassign or delete them first."});
        };
        ...
        return res.status(500).json({ message:"Error fetching delete category",error: error.message});
     }
  }